...
import {NavigationEnd, Route, RouteConfigLoadEnd, Router, RouterOutlet} from '@angular/router'
...
export class AppComponent {
  ...
  private bindRouterEvents(router: Router) {
    ...
    ).subscribe(route => this.hideUi.set((route.data && route.data['headless']) === true));
  }
}
